...
const updateTicket = async (req, res) => {
    ...
    try {
        ...
        const lookup = await db.collection("tickets").findOneAndUpdate(
            { uid: parseInt(ticket.uid) },
            {
                $set: {
...
module.exports = { postNew, getUsers, getAllTickets, getSpecificTicket, updateTicket };